...
<template>
	<section class="bg-surface-container-low py-32" v-editable="blok">
		<div class="mx-auto max-w-screen-2xl px-8">
			<div class="mb-24 flex flex-col justify-between gap-8 md:flex-row md:items-baseline">
			...
			<div class="mt-24 text-center" v-if="blok.cta_label">
				<a
